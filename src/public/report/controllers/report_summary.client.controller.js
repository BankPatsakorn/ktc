        ...
        if ($scope.selectVehicle != "" && $scope.selectVehicle != null && $scope.selectVehicle !== '0' &&
          ...
          reportSummaryFactory.getDataReportSingle(_data, res => {
            if (res.rows.length > 0) {
              $scope.dataReportSummarySingle = res.rows
            } else {
              $scope.dataReportSummarySingle = []
        ...
        scope.setDataTable = (data) => {
          ...
          return element.DataTable({
            columns: [{
              ...
              data: data => data.st_date,
              responsivePriority: 1
            }, {
              title: $rootScope.text.page_report_summary.table.single.usage,
              data: data => data.trip_distance
            }, {
              title: $rootScope.text.page_report_summary.table.single.fuel,
              data: data => data.trip_fuel
            }, {
              title: $rootScope.text.page_report_summary.table.single.inout,
              data: data => data.inout
            }, {
              title: $rootScope.text.page_report_summary.table.single.in_green_zone,
              data: data => data.ovsp_count
            }, {
              title: $rootScope.text.page_report_summary.table.single.in_red_zone,
              data: data => data.ovsp_distance
            }, {
              title: $rootScope.text.page_report_summary.table.single.idling_time,
              data: data => data.idle_timeuse
            }, {
              title: $rootScope.text.page_report_summary.table.single.idling_value,
        ...
        scope.setDataTable = (data) => {
          ...
          return element.DataTable({
            columns: [{
              ...
              title: $rootScope.text.page_report_summary.table.group.overspeed_time,
