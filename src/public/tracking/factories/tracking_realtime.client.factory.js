    ...
    return {
      getTrackingRealtime: callback => {
        if ($rootScope.authentication.token) {
          ...
          $iService.postByHeader(`${$iService.url()}tracking_realtime_italthai`, strJson, header, (res) => {
      ...
      setNote: (data, callback) => {
        if ($rootScope.authentication.token) {
          ...
          $iService.postByHeader(`${$iService.url()}set_note_italthai`, strJson, header, (res) => {
